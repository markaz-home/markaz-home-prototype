 ...
 *
 * On first UAE PASS sign-in the `handle_new_user` trigger creates the normal
 * CUSTOMER profile; the app guard reroutes the user to profile setup if needed.
 * UAE PASS remains a sign-in method only. Never logs the code or tokens.
 */
